...
## week 2
2. <b>bericht opslaan in array, arrayelementen inladen in html</b><br>
...
3. <b>controleren op command, bericht vervangen door bericht van API (en ook met specifieke nummers!)</b><br>
...
4. <b>object maken van bericht voor meer informatie (tijd, ID)</b><br>
...
## week 3
5. <b>Server-sent events API</b><br>
...
6. <b>dmv 'nep- id' een gesprek tussen 2 windows nabootsten.</b><br>
...
7. <b>Login pagina</b><br>
8. <b>User ID en cookie API</b><br>
...
- <b>client-side javascript die op de server werkt</b><br>
